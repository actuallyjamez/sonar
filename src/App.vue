        ...
        <div id="background" v-bind:style="{ 'background-image': 'url(' + image + ')' }">
            ...
            <div id="icon">
                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" height="64" width="64">
                    <defs>
                        <ellipse id="ellipse-1" opacity="1" rx="32" ry="32" cx="32" cy="32"/>
                    ...
                    <g opacity="1">
                        <use xlink:href="#ellipse-1" fill-opacity="0" stroke="rgb(255,255,255)" stroke-opacity="1" stroke-width="20" stroke-linecap="butt" stroke-linejoin="miter" mask="url(#mask-2)"/>
                    </g>
                </svg>
            </div>
                ...
                initSpotify()
                    .then(player => {
                        ...
                        player.addListener("player_state_changed", state => {
                            this.song_title = state.track_window.current_track.name
                            this.song_artist = state.track_window.current_track.artists[0].name
                            // this.log = state.track_window.current_track
                            this.image = state.track_window.current_track.album.images[2].url
                        })
